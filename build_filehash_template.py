    ...
    "actions": {
        ...
        "For_each_FileHash_entity": {
            ...
            "actions": {
                ...
                "Append_FileHash_block": {
                    "runAfter": after("Compose_VerdictReason"), "type": "AppendToStringVariable",
                    "inputs": {"name": "HtmlBody", "value": HASH_BLOCK},
                },
            },
        },
        "Condition_any_FileHash_entities": {
            "runAfter": after("For_each_FileHash_entity"), "type": "If",
            "expression": {"and": [{"greater": ["@length(coalesce(body('Entities_-_Get_File_Hashes')?['FileHashes'], json('[]')))", 0]}]},
            "actions": {
